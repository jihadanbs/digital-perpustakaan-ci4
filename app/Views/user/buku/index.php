                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="<?= esc(site_url('user/buku/tambah'), 'attr') ?>" class="btn waves-effect waves-light" style="background-color: #28527A; color:white;">
                            ...
                            <a href="<?= site_url('/user/buku/exportExcel') ?>" class="btn btn-success waves-effect waves-light me-1 mb-3">
    ...
    <script>
        $(document).ready(function() {
            var table = $("#example1").DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?= site_url('user/buku/get_data') ?>",
                    "type": "POST",
                    "data": function(d) {
            ...
            $.ajax({
                url: '<?= site_url('user/buku/get_kategori') ?>',
                type: 'GET',
